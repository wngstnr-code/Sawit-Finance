"""Sawit Finance — x402 Facilitator + gated data server (demo): gates mock CPO data behind the x402 micropayment protocol to demonstrate the client end-to-end over HTTP."""
...
PRICE_MOTES = int(os.getenv("X402_PRICE_MOTES", "10000000"))
